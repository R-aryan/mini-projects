...
class Deck:
    ...
    def shuffle_cards(self):
        print("Shufing the deck of cards......")
        random.shuffle(self.allcards)
    
    def split_in_half(self):
        print("Spliting cards into two halves")
...
print("Game Over and it lasted "+str(total_rounds)+"  rounds")
print("War occured "+str(war_count)+" times")

print("Does the computer still have cards?  "+ str(comp.still_has_cards()))
print("Does the Player still have cards?  "+ str(user.still_has_cards()))
